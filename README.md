...
<table style="width: 100%; table-layout: fixed;">
  <tr>
    <th style="width: 50%; text-align: center; border-bottom: 1px solid #ddd; padding: 10px;">메인 화면 1</th>
    <th style="width: 50%; text-align: center; border-bottom: 1px solid #ddd; padding: 10px;">메인 화면 2</th>
  </tr>
  <tr>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/76a3f0aa-6b4e-42e0-ba38-f670ab45d491" style="width: 100%; height: auto;">
    </td>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/cf6d73be-cdbb-47a5-860d-ccf9768813a7" style="width: 100%; height: auto;">
    </td>
  </tr>
</table>
...
<table style="width: 100%; table-layout: fixed;">
  <tr>
    <th style="width: 50%; text-align: center; border-bottom: 1px solid #ddd; padding: 10px;">메인 화면 3</th>
    <th style="width: 50%; text-align: center; border-bottom: 1px solid #ddd; padding: 10px;">메인 화면 4</th>
  </tr>
  <tr>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/ac936ccb-8631-457c-a2dd-fb403e05ba56" style="width: 100%; height: auto;">
    </td>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/b0bacb0f-eeb8-4ea5-ac78-625ffdda4655" style="width: 100%; height: auto;">
    </td>
  </tr>
</table>
...
<table style="width: 100%; table-layout: fixed;">
  <tr>
    <th style="width: 50%; text-align: center; border-bottom: 1px solid #ddd; padding: 10px;">소셜 로그인</th>
    <th style="width: 50%; text-align: center; border-bottom: 1px solid #ddd; padding: 10px;">결제</th>
  </tr>
  <tr>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/c3b17d9a-f1fe-46f7-8fc1-e0fc01363047" style="width: 100%; height: auto;">
    </td>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/46800211-8858-4670-b360-0cc1d9cbe998" style="width: 100%; height: auto;">
    </td>
  </tr>
</table>
...
<table style="width: 100%; table-layout: fixed;">
  ...
  <tr>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/a292570f-7883-4239-98ce-2758307bc6fb" style="width: 100%; height: auto;">
    </td>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/553f2284-d5e2-4565-9f2e-0253b851d3ef" style="width: 100%; height: auto;">
    </td>
  </tr>
</table>

<table style="width: 100%; table-layout: fixed;">  <tr>
    <th style="width: 50%; text-align: center; border-bottom: 1px solid #ddd; padding: 10px;">상세페이지 1</th>
    <th style="width: 50%; text-align: center; border-bottom: 1px solid #ddd; padding: 10px;">상세페이지 2</th>
  </tr>
  <tr>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/84477340-6c30-4f00-a49e-9c1807e9d24d" style="width: 100%; height: auto;">
    </td>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/be905a6b-d0e6-4637-a81e-d81f663514b3" style="width: 100%; height: auto;">
    </td>
  </tr>
</table>
...
<table style="width: 100%; table-layout: fixed;">  
  <tr>
    <th style="width: 50%; text-align: center; border-bottom: 1px solid #ddd; padding: 10px;">카테고리 1</th>
    <th style="width: 50%; text-align: center; border-bottom: 1px solid #ddd; padding: 10px;">카테고리 2</th>
  </tr>
  <tr>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/a292570f-7883-4239-98ce-2758307bc6fb" style="width: 100%; height: auto;">
...
<table style="width: 100%; table-layout: fixed;">
  <tr>
    <th style="width: 50%; text-align: center; border-bottom: 1px solid #ddd; padding: 10px;">메이트 등록</th>
    <th style="width: 50%; text-align: center; border-bottom: 1px solid #ddd; padding: 10px;">의뢰</th>
  </tr>
  <tr>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/c46b96f2-d633-4ffc-9277-bb6e497e76b7" style="width: 100%; height: auto;">
    </td>
    <td style="width: 50%; text-align: center;">
      <img src="https://github.com/user-attachments/assets/e748f450-b3aa-4a64-b99b-9158ae63799a" style="width: 100%; height: auto;">
    </td>
  </tr>
</table>
