  ...
  return (
    <div className='relative mb-[61px] h-[214px] w-full'>
      ...
      <textarea
        ...
        className='h-[168px] w-full resize-none rounded-xl bg-primary px-6 py-5 text-gray-500 focus:outline-none [&::-webkit-scrollbar]:hidden'
      ...
      />
      <p className='absolute bottom-[10px] right-4 text-gray-400'>{profile.description?.length} / 200</p>
    </div>
  );
}
