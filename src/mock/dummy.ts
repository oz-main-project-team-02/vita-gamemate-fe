...
export const dummyChatLists: ChatList[] = [
    {
        ...
        last_message_time: new Date('2024-10-17 10:05:00'),
    },
    {
        chat_room_id: 2,
        profile_image: 'https://example.com/images/user2.jpg',
        nickname: 'GamerPro',
        last_message: "Let's meet in the lobby.",
        last_message_time: new Date('2024-10-17 11:15:00'),
    },
    {
        chat_room_id: 3,
        profile_image: 'https://example.com/images/user3.jpg',
        nickname: 'NoobMaster',
        last_message: "I just joined, what's next?",
        last_message_time: new Date('2024-10-17 12:30:00'),
    },
    {
        chat_room_id: 4,
        profile_image: 'https://example.com/images/user4.jpg',
        nickname: '게임왕',
        last_message: '오늘 저녁에 게임 가능?.',
        last_message_time: new Date('2024-10-17 13:05:00'),
    },
    {
        chat_room_id: 5,
        profile_image: 'https://example.com/images/user5.jpg',
        nickname: '전설의고수',
        last_message: '다음 판 준비 됐어?',
        last_message_time: new Date('2024-10-17 14:15:00'),
    },
    {
        chat_room_id: 6,
        profile_image: 'https://example.com/images/user6.jpg',
        nickname: '초보자',
        last_message: '지금 시작할 수 있나요?',
        last_message_time: new Date('2024-10-17 15:30:00'),
    },
];
    ...
    messages: [
        {
            ...
            created_at: new Date('2024-10-17 10:00:00'),
        },
        {
            message_id: 2,
            user_id: 101,
            ...
            created_at: new Date('2024-10-17 10:00:30'),
        },
        {
            message_id: 3,
            user_id: 102,
            ...
            created_at: new Date('2024-10-17 10:01:00'),
        },
        {
            message_id: 4,
            user_id: 102,
            ...
            created_at: new Date('2024-10-17 10:01:30'),
        },
        {
            message_id: 5,
            user_id: 101,
            ...
            created_at: new Date('2024-10-17 10:02:00'),
        },
        {
            message_id: 6,
            user_id: 101,
            message:
                '그럼, 오늘 저녁에 8시쯤 만날까? 나도 좀 더 연구해볼 테니 그때 다시 이야기하자',
            created_at: new Date('2024-10-17 10:02:30'),
        },
        {
            message_id: 7,
            user_id: 102,
            message: '그래. 이따 8시에 봐!',
            created_at: new Date('2024-10-17 10:05:00'),
        },
    ],
};
